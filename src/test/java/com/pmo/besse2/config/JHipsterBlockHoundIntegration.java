...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.pmo.besse2.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.pmo.besse2.security.DomainUserDetailsService", "createSpringSecurityUser");
